...
export default function CompanyPage() {
  ...
  return (
    <div className="min-h-screen page-bg flex flex-col">
      ...
      <main className="flex-1 max-w-5xl mx-auto w-full px-4 py-12 space-y-16">

        {/* About */}
        <section>
          <h1 className="text-4xl font-extrabold text-white mb-4">About WebShield</h1>
          <p className="text-gray-400 text-lg leading-relaxed max-w-3xl">
            {about || 'WebShield is a modern web security platform helping development teams and security engineers find and fix vulnerabilities before attackers do.'}
          </p>
        </section>
        ...
        {values.length > 0 && (
          <section>
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {values.map((v, i) => {
                const title = v.Title ?? v.title ?? v.Name ?? v.name ?? v
